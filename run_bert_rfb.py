...
class DataTrainingArguments:
    ...
    def __post_init__(self):
        if self.dataset_name is None and self.train_file is None and self.valid_file is None:
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.valid_file is not None:
            data_files["val"] = data_args.valid_file
    ...
    if training_args.do_train:
        ...
        column_names = raw_datasets["val"].column_names
        features = raw_datasets["val"].features
